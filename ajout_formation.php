...
<?php include 'includes/header.php'; ?>
    ...
    <form id="form_principale">
        ...
        <div id="etape1" class="etape active">
            ...
            <input type="text" placeholder="Nom Formation" id="nom_formation" required><br><br>
            <label for="date">Date de début:</label><br>
            <input type="date"  id="date" required><br><br>
            <label for="nbr_jour">Nombre de jour de formation:</label><br>
            <input type="number" id="nb_jour" min="1" value="5"><br><br>
        ...
        <div id="etape2" class="etape">
            ...
            <input type="number" min="0" value="20" id="nb_participant"><br><br>
        ...
        <div id="etape3" class="etape">
            ...
            <input type="text"  id="prenom_formateur"><br><br>
